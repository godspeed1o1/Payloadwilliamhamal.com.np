# William Hamal Gazette — Payload migration

This project rebuilds `williamhamal.com.np` with Payload CMS and Next.js while preserving its newspaper-inspired visual identity. Start with [TUTORIAL.md](./TUTORIAL.md) for the complete file-by-file walkthrough, then use [LEARNING.md](./LEARNING.md) as the shorter reference.

The underlying project began from Payload's official Website Template, so the original template notes remain below as an additional reference.
